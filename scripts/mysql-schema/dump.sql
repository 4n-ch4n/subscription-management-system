...
('p1111111-1111-4444-8888-000000000008', 'company:delete'),
('p1111111-1111-4444-8888-000000000009', 'company:read');
...
('a0000001-0000-4444-8888-000000000002', 'r2222222-2222-4444-8888-000000000001', 'p1111111-1111-4444-8888-000000000002'), -- user:edit
('a0000001-0000-4444-8888-000000000003', 'r2222222-2222-4444-8888-000000000001', 'p1111111-1111-4444-8888-000000000003'), -- user:delete
('a0000001-0000-4444-8888-000000000004', 'r2222222-2222-4444-8888-000000000001', 'p1111111-1111-4444-8888-000000000004'), -- company:edit
('a0000001-0000-4444-8888-000000000005', 'r2222222-2222-4444-8888-000000000001', 'p1111111-1111-4444-8888-000000000005'), -- billing:view
('a0000001-0000-4444-8888-000000000006', 'r2222222-2222-4444-8888-000000000001', 'p1111111-1111-4444-8888-000000000006'), -- billing:edit
('a0000001-0000-4444-8888-000000000007', 'r2222222-2222-4444-8888-000000000001', 'p1111111-1111-4444-8888-000000000007'), -- reports:generate
('a0000001-0000-4444-8888-000000000008', 'r2222222-2222-4444-8888-000000000001', 'p1111111-1111-4444-8888-000000000008'), -- company:delete
('a0000001-0000-4444-8888-000000000009', 'r2222222-2222-4444-8888-000000000001', 'p1111111-1111-4444-8888-000000000009'); -- company:read

-- ADMIN: Can manage users and company details but cannot delete the company or manage billing
INSERT INTO role_has_permissions (id, rol_id, permission_id) VALUES
...
('a0000002-0000-4444-8888-000000000003', 'r2222222-2222-4444-8888-000000000002', 'p1111111-1111-4444-8888-000000000003'), -- user:delete
('a0000002-0000-4444-8888-000000000004', 'r2222222-2222-4444-8888-000000000002', 'p1111111-1111-4444-8888-000000000004'), -- company:edit
('a0000002-0000-4444-8888-000000000005', 'r2222222-2222-4444-8888-000000000002', 'p1111111-1111-4444-8888-000000000005'), -- billing:view
('a0000002-0000-4444-8888-000000000006', 'r2222222-2222-4444-8888-000000000002', 'p1111111-1111-4444-8888-000000000007'), -- reports:generate
('a0000002-0000-4444-8888-000000000007', 'r2222222-2222-4444-8888-000000000002', 'p1111111-1111-4444-8888-000000000009'); -- company:read
...
('a0000003-0000-4444-8888-000000000005', 'r2222222-2222-4444-8888-000000000003', 'p1111111-1111-4444-8888-000000000009'); -- company:read
...
('a0000004-0000-4444-8888-000000000002', 'r2222222-2222-4444-8888-000000000004', 'p1111111-1111-4444-8888-000000000007'), -- reports:generate
('a0000004-0000-4444-8888-000000000003', 'r2222222-2222-4444-8888-000000000004', 'p1111111-1111-4444-8888-000000000009'); -- company:read
